...
from EnvMixDyadTraining import DyadTrackingEnv
...
class DataSaver:
    ...
    """
    def __init__(self, save_dir="./mix_tracking_data_dual"):
...
def collect_dual_tracking_data(total_timesteps=10000, sequence_length=10, auto_save=True, save_dir="./dual_tracking_data"):
    """
