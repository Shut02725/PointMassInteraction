...
from EnvSoloTraining import SoloTrackingEnv
...
class DataSaver:
    ...
    """
    def __init__(self, save_dir="./solo_tracking_data"):
...
def collect_solo_tracking_data(total_timesteps=100000, sequence_length=10, auto_save=True, save_dir="./solo_tracking_data"):
    """
