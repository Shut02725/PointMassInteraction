...
class DyadTrackingEnv:
    ...
    def step(self):
        ...
        self.agent1_self_obs[0] = agent1_pos_noisy[0] - target_pos_noisy[0]
        self.agent1_self_obs[1] = agent1_pos_noisy[0] - agent1_partner_target_pos[0]
        self.agent1_self_obs[2] = agent1_pos_noisy[1] - target_pos_noisy[1]
        self.agent1_self_obs[3] = agent1_pos_noisy[1] - agent1_partner_target_pos[1]
        
        self.agent2_self_obs[0] = agent2_pos_noisy[0] - target_pos_noisy[0]
        self.agent2_self_obs[1] = agent2_pos_noisy[0] - agent2_partner_target_pos[0]
        self.agent2_self_obs[2] = agent2_pos_noisy[1] - target_pos_noisy[1]
        self.agent2_self_obs[3] = agent2_pos_noisy[1] - agent2_partner_target_pos[1]
